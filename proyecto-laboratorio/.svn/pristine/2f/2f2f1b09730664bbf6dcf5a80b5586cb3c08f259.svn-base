...
Calendar.prototype.update = function () {
  ...
  //  console.log("calendarContainer-day-num "+ this.id + '-day-num-' + (this.label.indexOf(label[firstDay]) + i));
...
Organizer.prototype.setupBlock = function (blockId, theOrganizer, callback) {
  ...
  document.getElementById(calendarId + "-day-" + blockId).addEventListener('click', function () {
    ...
    if (document.getElementById(calendarId + "-day-num-" + blockId).innerHTML.length > 0) {
      ...
      console.log("es callback +" + calendarId + "-day-" + blockId);
      console.log("className " + document.getElementById(calendarId + "-day-" + blockId).className);
     /** 
      let elm = document.getElementById(calendarId + "-day-" + blockId);
...
var calendar = new Calendar("calendarContainer", "small", [ "Lunes", 3 ], [ "#e91e63", "#c2185b", "#ffffff", "#f8bbd0" ]);
