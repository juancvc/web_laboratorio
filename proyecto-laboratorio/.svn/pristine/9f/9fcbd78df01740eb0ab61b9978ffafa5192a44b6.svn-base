	...
	<div class="content-wrapper">
		<div class="container-fluid">
			...
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">Listado de maestras</li>
			</ol>-->
	<div class="tituloForm">LISTADO DE MAESTRAS</div>
			<!-- Icon Cards--> 
			<!-- Area Chart Example-->
			<div class="card mb-3">
				...
				<f:form id="frmListadoMaestra" class="form-horizontal" role="form"
					enctype="multipart/form-data" method="post"
					action="${pageContext.request.contextPath}/maestraController/buscar">
					...
					<div class="card-body">
						<div class="form-group">
							...
							<div class="row">
								...
								<div class="col-md-4">
									<label for="exampleInputName" class="label_control"><span
										class="required">*</span> NOMBRE DE LA TABLA</label>
									<div class="controls">
								...
								<div class="col-md-4">
									<label for="exampleInputName" class="label_control">NOMBRE CORTO
										</label>
									<f:input type="text" class="form-control" id="nombreCorto"
										path="nombreCorto" maxlength="150" />
								</div>
							...
							<div class="row">
								<div class="form-group col-md-12 text-right"
									...
									<a
										href="${pageContext.request.contextPath}/maestraController/nuevo"
								...
								<div class="table-responsive">
									<table class="table table-bordered" id="dataTable">
										...
										<tbody id="idBodyListaCIEX">
											<c:forEach var="tabla" items="${lstTablasRegistros}"
												varStatus="loop">
												<tr>
													<td>${loop.count}</td>
													<td>${tabla.nombreCorto}</td>
													<td>${tabla.valor1}</td>
													<td>${tabla.valor2}</td>
													<td>${tabla.valor3}</td>
													<td><a title="Modificar" data-placement="top"
														...
														onclick="javascript:modificarElementoGenericoTabla('/maestraController/modificar','${tabla.tabla}','${tabla.codReg}')"
														...
														<button type="button"
															...
															onclick="confirmar_accion('${tabla.tabla}','${tabla.codReg}')"
															data-original-title="Eliminar"
															id="eliminarPerfil${tabla.codReg}">
...
<script>
	...
	function modificarElementoGenericoTabla(url, tabla, idElemento){
		var urlComplete = document.getElementById('url_base-proyecto').value + url;
		doPost(urlComplete, { tabla : tabla , codigo : idElemento } );
	}
