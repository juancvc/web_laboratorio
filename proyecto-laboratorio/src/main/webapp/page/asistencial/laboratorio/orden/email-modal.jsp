...
<div class="modal-dialog modal-lg" role="document">
	<div class="modal-content">
		<div class="modal-header">
			<label class="modal-title text-text-bold-600" id="myModalLabel35"><b>ENVIO
					DE CORREO</b></label>
		...
		<f:form id="reused_form" class="form-horizontal" role="form"
			...
			<f:input type="hidden" class="form-control" id="personaCodigo"
						...
						<label for="exampleInputName" class="label_control">CORREO
							...
							<div class="controls">
								<f:input type="text" class="form-control" required="required" disabled="true"
									maxlength="50" id="nroDocumentoPersona" path="correo"
				...
				<div class="row">
					<div class="form-group col-md-4 mb-2">
						<label for="nombreCompleto" class="label_control">DATOS
							ADJUNTOS <span class="required">*</span>
						</label>
     		 ...
     		 <input class="file-path validate" type="text" id="pdf"  >
   			 </div>
  				</div>
				</form>
				...
				<div class="row">
					<div class="form-group col-md-4 mb-2">
						<label for="email" class="label_control">CORREO
							A ENVIAR <span class="required">*</span>
						</label>
						<div class="controls">
							<f:input type="email" class="form-control" required="required"  maxlength="50"
								id="email" name="email"
            ...
            id="message" placeholder="Escriba un mensaje"
    ...
    style="width:100%; height:100%; display:none; ">
	 ...
	 <button type="submit" class="btn btn-lg btn-success btn-block" onclick="enviarEmail()"
...
$(function()
{
	...
	function enviarEmail(){
		...
		$.ajax({
			...
			+ mensaje + "&pdf=" + pdf+ "&correoDestino=" + email,
