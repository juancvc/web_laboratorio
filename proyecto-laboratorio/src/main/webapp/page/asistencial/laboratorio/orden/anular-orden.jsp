...
<div class="modal-dialog modal-sm" role="document">
	<div class="modal-content">
		<f:form id="frmAnularOrden" class="form-horizontal"
		...
		<div class="label_title_modal modal-header">
			...
			<h4 class="label_title" id="myModalLabel19">ANULAR ORDEN</h4>
		...
		<div class="modal-body">
			...
			<div class="row">
				<div class="col-md-12">
					<label for="situacion" class="label_control">DETALLE MOTIVO DE ANULACIÓN <span class="required">*</span>
					</label>
