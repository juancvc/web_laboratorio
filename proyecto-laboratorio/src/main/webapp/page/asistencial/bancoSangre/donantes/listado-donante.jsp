...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
	...
	<div class="content-wrapper">
		<div class="container-fluid">
			...
			<div class="tituloForm">LISTADO DE DONANTES</div>
			<!-- Area Chart Example-->
			<div class="card mb-3">
				...
				<f:form id="frmlistadoReferencia" role="form"
					action="${pageContext.request.contextPath}/bancoController/buscarCampania">
							...
							<div class="row">
								<div class="col-md-4">
									<label for="exampleInputName" class="label_control">NOMBRE
										DONANTE</label>
									<f:input id="txtNombreDonante" name="txtDatosReferencia"
										type="text" class="form-control" path="persona.nombreCompleto" size="7"
										maxlength="7" />
								</div>
								<div class="col-md-3">
									...
									<div class="controls">
										<f:select id="cboSituacion" path="situacion.codReg"  class="form-control">
							...
							<div class="table-responsive">
								<table class="table table-bordered" id="dataTable">
									...
									<tbody id="idBodyListaCampania">
										<c:forEach var="campania" items="${lstCampaniaBean}" varStatus="loop">
											<tr>
												<td>${loop.count}</td>
												...
												<td><a title="Modificar" data-placement="top"
														...
														onclick="javascript:modificarElementoGenerico('/bancoController/modificarCampania','${loop.index}')"
