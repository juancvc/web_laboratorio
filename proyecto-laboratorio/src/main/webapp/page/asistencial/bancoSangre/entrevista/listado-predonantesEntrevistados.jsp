...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
	...
	<div class="content-wrapper">
		<div class="container-fluid">
			...
			<div class="tituloForm">LISTADO DE POSTULANTES ENTREVISTADOS</div>
			<!-- Area Chart Example-->
			<div class="card mb-3">
				...
				<f:form id="frmlistadoReferencia" role="form"
					action="${pageContext.request.contextPath}/entrevistaController/buscarEntrevistados">
					...
					<div class="card-body">
						<div class="form-group">
							<div class="row">
							 <div class="col-md-4">
									<label for="nombreCompleto" class="label_control">FECHA <span class="required">*</span>
									</label>
									<f:input class="form-control" id="date" name="date" required="required" 
							...
							<div class="table-responsive">
								<table class="table table-bordered" id="dataTable">
									...
									<tbody id="idBodyListaPostulante">
										<c:forEach var="preDonante" items="${lstPreDonanteBean}" varStatus="loop">
											<tr>
												<td>${loop.count}</td>
												<td>${preDonante.postulanteBean.codigo}</td> 
												<td>${preDonante.postulanteBean.persona.nroDocumento}</td>
												<td>${preDonante.postulanteBean.persona.nombreCompleto}</td>
												<td>${preDonante.postulanteBean.campania.lugarCampaniaBean.nombre}</td>  
												<td><fmt:formatDate pattern="dd/MM/yyyy HH:mm a" value="${preDonante.fechaCreacion}" /></td> 
												<td>${preDonante.resultado.nombreCorto}</td>
												<td>${preDonante.observacion}</td>	
												<td>
												<a
												href="${pageContext.request.contextPath}/entrevistaController/rptFichaPostulante?index=${loop.index}"
												class="btn btn-outline-success btn-sm" title=""> <i class="fa fa-print"></i>
												IMPRIMIR REPORTE
												</a> 
												</td>
											</tr>
