...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
	...
	<div class="content-wrapper">
		<div class="container-fluid">
			...
			<div class="tituloForm">LISTADO DE POSTULANTES PARA ENTREVISTA</div>
			<!-- Area Chart Example-->
			<div class="card mb-3">
								...
								<table class="table table-bordered" id="dataTable">
									<thead class="tabla_th">
										<tr>
											...
											<th>FECHA/HORA EVALUACION</th>
											<th>RESULTADO EVALUACION</th>
											<th>ACCIONES</th>
										</tr>
									</thead>
									<tbody id="idBodyListaPostulante">
										<c:forEach var="postulante" items="${lstPostulanteBean}" varStatus="loop">
											<tr>
												...
												<td>${postulante.persona.nroDocumento}</td>
												...
												<td>${postulante.estadoFisicoBean.calificacion.nombreCorto}</td>
													...
													<c:when
														...
														<td><a title="Entrevistar" data-placement="top"
														data-toggle="tooltip"
														class="btn btn-outline-success btn-sm"
														onclick="javascript:modificarElementoGenerico('/entrevistaController/registroEntrevista','${loop.index}')"
														href="#">ENTREVISTAR</a> <!--   <a title="Eliminar" data-placement="top" data-toggle="tooltip"
													...
													<c:otherwise>  
														...
														onclick="javascript:modificarElementoGenerico('/entrevistaController/registroEntrevista','${loop.index}')"
														href="#"><i class="ft-search"></i> ENTREVISTAR  </a></td>
													</c:otherwise>
												</c:choose> 
