	...
	<div class="content-wrapper">
		<div class="container-fluid">
			...
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">Listado de Perfil</li>
			</ol>-->
		 <div class="tituloForm">LISTADO DE PERFIL</div>
			<!-- Icon Cards-->
			<div class="row"></div>
			<!-- Area Chart Example-->
			<div class="card mb-3"> 
					 ...
					 <div class="card-body">
						<div class="form-group">
							...
							<div class="row">
								 ...
								 <div class="col-md-8">
									<label for="exampleInputName" class="label_control">NOMBRE PERFIL</label>
									<f:input type="text" class="form-control" id="nombrePerfil"
										path="nombrePerfil"  maxlength="250"/>
								</div>
											...
											<c:forEach var="perfil" items="${lstPerfilBean}"
												...
												<tr>
													...
													<td> 
														...
														onclick="javascript:modificarElementoGenerico('/perfilController/modificar','${perfil.codigo}')"
														...
														<button type="button"
															...
															onclick="confirmar_accion('${perfil.codigo}')"
															data-original-title="Eliminar"
															id="eliminarPerfil${perfil.codigo}">
